      ...
      <main className="relative z-10 container mx-auto px-4 pt-10 flex flex-col items-center gap-10 flex-grow cursor-pointer">
        ...
        <div className="flex justify-center w-full mt-4 mb-8 cursor-pointer">
          <motion.a 
            ...
            {...hoverEffect}
          >
            <div className="flex items-center gap-2 bg-[linear-gradient(45deg,#72E033,#6633E6,#FF66CC,#3399FF)] hover:brightness-110 text-white border-2 border-black px-6 py-3 rounded-lg shadow-[4px_4px_0_0_rgba(0,0,0,1)] font-display text-xl cursor-pointer">
