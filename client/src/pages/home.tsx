      ...
      <main className="relative z-10 container mx-auto px-4 pt-10 flex flex-col items-center gap-10 flex-grow cursor-pointer">
        ...
        <div className="flex justify-center w-full mt-4 mb-8 cursor-pointer">
          <motion.a 
            ...
            {...hoverEffect}
          >
            <div className="flex items-center gap-2 bg-[linear-gradient(45deg,#72E033,#6633E6,#FF66CC,#3399FF)] hover:brightness-110 text-white border-2 border-black px-4 py-2 rounded-lg shadow-[4px_4px_0_0_rgba(0,0,0,1)] font-display text-lg cursor-pointer">
              <svg viewBox="0 0 24 24" className="w-5 h-5 fill-current" aria-hidden="true">
                <path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z"></path>
              </svg>
              OFFICIAL X
