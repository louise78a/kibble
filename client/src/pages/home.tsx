    ...
    <div className="min-h-screen bg-black text-white overflow-hidden pb-20">
      ...
      <main className="relative z-10 container mx-auto px-4 pt-10 flex flex-col items-center gap-10">
        ...
        <div className="text-center space-y-4">
          <motion.h1 
            className="text-7xl md:text-9xl font-display text-meme-pink text-stroke drop-shadow-[0_10px_0_rgba(255,255,255,0.2)]"
            animate={{ scale: [1, 1.05, 1], rotate: [0, 2, -2, 0] }}
            transition={{ duration: 2, repeat: Infinity }}
          >
            $BOJACK
          </motion.h1>
          <p className="text-2xl md:text-4xl text-meme-green font-bold text-stroke-sm -rotate-2">
