          ...
          <div className="bg-[#451A03] text-[#FFFBEB] rounded-3xl p-8 md:p-12 shadow-2xl overflow-hidden relative">
            <div className="relative z-10 space-y-8">
              ...
              <div className="flex flex-wrap justify-center gap-4">
                ...
                <Button 
                  className="bg-[#1DA1F2] hover:bg-[#1A91DA] text-white font-bold text-lg px-8 h-12 rounded-full border border-[#78350F] gap-2"
                ...
                <Button 
                  className="bg-[#0088cc] hover:bg-[#0077b5] text-white font-bold text-lg px-8 h-12 rounded-full border border-[#78350F] gap-2"
